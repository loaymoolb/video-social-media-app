...
const VideoCard: NextPage<IProps> = ({ post }) => {
  ...
  return (
    <div className="flex flex-col border-b-2 border-gray-200 pb-6">
      ...
      <div className="lg:ml-20 flex gap-4 relative lg:w-[600px] h-[300px] md:h-[400px] lg:h-[528px] w-[200px]">
        <div
        ...
        className="rounded-3xl">
          ...
          {isHover && (
            <div className="absolute bottom-6 cursor-pointer left-8 md:left-14 lg:left-2 flex gap-10 lg:justify-between w-[100px] md:w-[50px] lg:w-[580px] p-3">
              {playing ? (
                <button
